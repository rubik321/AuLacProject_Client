...
namespace Rubik.Myrk.Ranking
{
    ...
    public class RankingPlayerRewardItem : MonoBehaviour
    {
        ...
        public void SetData(string displayName, int level, int avatarIndex, int borderIndex, int rank, long score, List<ItemData> rewards, bool isGreen = false)
        {
            ...
            this.TextLevel.text = "Lv. " + (level+1);
