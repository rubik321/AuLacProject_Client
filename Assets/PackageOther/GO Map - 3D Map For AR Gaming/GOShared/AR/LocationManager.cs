		...
		void GPSLocationCheck () {
			...
			if (!useLocationServices) {
				if (Application.isEditor && useBannerInsideEditor)
                    BannerManager.Instance.AddTopBanner(BannerTopConfig.LocationUnstable, Lean.Localization.LeanLocalization.GetTranslationText("gps_disabled", "GPS is disabled"));
					// showBannerWithText (true, "GPS is disabled");
			}
			else if (status == LocationServiceStatus.Failed) {
                BannerManager.Instance.AddTopBanner(BannerTopConfig.LocationUnstable, Lean.Localization.LeanLocalization.GetTranslationText("gps_not_found", "GPS signal not found"));
                ...
                BannerManager.Instance.AddTopBanner(BannerTopConfig.LocationUnstable, Lean.Localization.LeanLocalization.GetTranslationText("waiting_for_gps_signal", "Waiting for GPS signal"));
				...
				if (Input.location.lastData.horizontalAccuracy > desiredAccuracy) {
                    BannerManager.Instance.AddTopBanner(BannerTopConfig.LocationUnstable, Lean.Localization.LeanLocalization.GetTranslationText("gps_signal_weak", "GPS signal is weak"));
					// showBannerWithText (true, "GPS signal is weak");
				} else {
                    BannerManager.Instance.RemoveTopBanner(BannerTopConfig.LocationUnstable);
