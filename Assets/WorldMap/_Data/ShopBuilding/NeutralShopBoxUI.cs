...
namespace GOA.ShopBuilding
{
    ...
    public class NeutralShopBoxUI : MonoBehaviour
    {
        ...
        public void SetItem(ItemShopData itemShopData, NeutralShopData neutralShopData)
        {
            ...
            this.NeutralShopData = neutralShopData;
        ...
        public void SetGear(ItemGearShopData itemGearShopData, NeutralShopData neutralShopData)
        {
            this.NeutralShopData = neutralShopData;
            this.ItemData = null;
        ...
        {
            this.StackBuy = true;
            this.cost.text = (this.ItemShopData.Price + this.NeutralShopData.TimeBuy * this.NeutralShopData.CoinInc).ToString();
            this.costCash.text = (this.ItemShopData.Price + this.NeutralShopData.TimeBuy * this.NeutralShopData.CoinInc).ToString();
        ...
        public void SetDataGear()
        {
            ...
            if (gearData == null) gearData = new Gear.GearInfoData();
        ...
        public void Buy()
        {
            ...
            else
            {
                ...
                this.TimeBuy = this.NeutralShopData.TimeBuy;
                this.CoinInc = this.NeutralShopData.CoinInc;
            }
        ...
        public void ConfirmBuy(int amount)
        {
            ...
            APIManager.Instance.BuyNeutralShopData(itemID, gearID, slot, amount, this.NeutralShopData.Id, (System.Action<string>)((data) =>
            {
                ...
                try
                {
                    ...
                    neutralShopUI.UpdateData(JsonUtility.FromJson<NeutralShopData>(jdata["neutralShopData"].ToString()));
                }
                catch (System.Exception) { }
            }));
        }
        public void BuySuccess(int amount)
        {
            ...
            {
                UserData.Instance.data.Coin -= (amount + this.NeutralShopData.TimeBuy - 1) * this.NeutralShopData.CoinInc;
                this.NeutralShopData.TimeBuy += amount;
                ...
                QuestManager.Instance.UpdateQuest(QuestType.Spend_Gold, (amount + this.NeutralShopData.TimeBuy - 1) * this.NeutralShopData.CoinInc);
            }
